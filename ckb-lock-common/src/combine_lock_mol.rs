...
impl ::core::default::Default for ChildScriptVecVec {
    fn default() -> Self {
        ...
        ChildScriptVecVec::new_unchecked(v.into())
    }
}
...
impl ::core::default::Default for ChildScriptArray {
    fn default() -> Self {
        let v: Vec<u8> = vec![4, 0, 0, 0];
        ChildScriptArray::new_unchecked(v.into())
    }
}
...
impl ::core::default::Default for ChildScriptConfig {
    fn default() -> Self {
        ...
        ChildScriptConfig::new_unchecked(v.into())
    }
}
...
impl ::core::default::Default for ChildScriptConfigOpt {
    fn default() -> Self {
        let v: Vec<u8> = vec![];
        ChildScriptConfigOpt::new_unchecked(v.into())
    }
}
...
impl ::core::default::Default for CombineLockWitness {
    fn default() -> Self {
        let v: Vec<u8> = vec![
            22, 0, 0, 0, 16, 0, 0, 0, 18, 0, 0, 0, 22, 0, 0, 0, 0, 0, 4, 0, 0, 0,
        ];
...
impl<'r> CombineLockWitnessReader<'r> {
    ...
    pub fn index(&self) -> Uint16Reader<'r> {
        let slice = self.as_slice();
        let start = molecule::unpack_number(&slice[4..]) as usize;
        let end = molecule::unpack_number(&slice[8..]) as usize;
